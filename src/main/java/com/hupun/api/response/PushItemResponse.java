 ...
 */
public class PushItemResponse extends BaseResponse<List<String>> {
    private static final long serialVersionUID = 8691751809856559768L;
    ...
    public List<String> parseData(String json) {
        ...
        if (json != null && json.length() > 0) {
            ...
            try {
                itemIDs = mapper.readValue(json, List.class);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
